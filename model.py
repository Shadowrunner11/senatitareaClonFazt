...
class Productos (Base):
    ...
    producto_id=Column(Integer(), unique=True, primary_key=True, nullable=False, autoincrement=True)
...
#session.commit()
def getProducts():
 return session.query(Productos.nombre, Productos.marca, Productos.precio, Productos.cantidad, Productos.producto_id).all()
